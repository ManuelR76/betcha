...
class bet_additional extends database {
...
//Méthode pour ajouter un utilisateur
    public function addPicture() {
        ...
        $query = 'INSERT INTO `bet_additional` (`path_picture`, `id_user`)'
                . ' VALUES (:path_picture, :id_user)';
        //Je prépare ma requête
        $addPicture = $this->DataBase->prepare($query);
        //Je bind mes values
        $addPicture->bindValue(':path_picture', $this->path_pictures, PDO::PARAM_STR);
        $addPicture->bindValue(':id_user', $this->id_user, PDO::PARAM_INT);
